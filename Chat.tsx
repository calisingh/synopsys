                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>I am your Synopsys Internal ChatGPT. Try me. Try me responsibly!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Synopsys ChatGPT may produce information about people, places, or facts that is not latest or is inaccurate. The Synopsys ChatGPT reference model is frozen in time. Refer to Synopsys ChatGPT FAQs to find out more at: TBD FAQs URL.</h2>
                            </Stack>
                        ) : (
